...
namespace CurrencyConverter
{
	...
	public class Option<T> : IEquatable<Option<T>>
	{
		...
		public T Value
		{
			get
			{
				if (IsNone) throw new InvalidOperationException("Le type option n'a pas de valeur");
				return _value;
			}
		}
		...
		public T GetOrElse(Func<T> elseFunc)
		{
			...
			return HasValue ? Value : elseFunc();
		}
		...
		public bool Exists(Func<T, bool> predicate)
		{
			...
			return HasValue && predicate(this.Value);
		}
