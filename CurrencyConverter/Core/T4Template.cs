...
namespace Edenred.France.Framework.Transform
{
    using System;
    using Edenred.France.Framework.Core;
	using Edenred.France.Framework.Transform;
    ...
    {	
		...
		public static Func<Either<TResult>> OnExceptionEither<TResult>([NotNull] this Func<TResult> func)
        {
